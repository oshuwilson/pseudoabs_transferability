...
for(z in 18){
  ...
  # export boyce scores
  saveRDS(sdpe_boyce_final, 
          file = paste0("output/temporal/sdpe/", this.species, "_", this.site, "_", this.stage, "_boyce_scores_sdpe.RDS"))
  
  # export self test 
  saveRDS(all_self,
          file = paste0("output/temporal/sdpe/", this.species, "_", this.site, "_", this.stage, "_self_test_sdpe.RDS"))
